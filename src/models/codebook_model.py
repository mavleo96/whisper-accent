...
class CodebookWhisperModel(L.LightningModule):
    ...
    def __init__(self, model_name, optimizer_config):
        ...
        self.model = WhisperWithAccentCodebook.from_pretrained(model_name)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # not normalizing the predicted text
        ...
        return {"predictions": predicted_text, "targets": target_text, "val_loss": loss}
